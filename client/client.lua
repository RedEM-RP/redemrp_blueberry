...
function goEat()
    ...
    Wait(2500)
    -- TriggerServerEvent('wwrp_status:eatberry') -- HERE IS PLACE TO YOU STATUS/BASICNEEDS TRIGGER
...
RegisterNetEvent('redemrp_blueberry:EatBlueBerry')
AddEventHandler('redemrp_blueberry:EatBlueBerry', function()
    local playerPed = PlayerPedId()
    RequestAnimDict("mech_pickup@plant@berries")
    while not HasAnimDictLoaded("mech_pickup@plant@berries") do
        Wait(100)
